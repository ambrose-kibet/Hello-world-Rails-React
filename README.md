...
**Hello-world-Rails-React** is a project wthat showcase how to build rails app with a react fronted.
...
```
cd my-folder
git clone https://github.com/ambrose-kibet/Hello-world-Rails-React.git
```
...
- Add the rest of the necessary features .
